...
public class projectDetails extends AppCompatActivity {
    public static final String TAG="projectDetails";
...
//        Toast.makeText(this, currentUser, Toast.LENGTH_SHORT).show();
        ...
        deleteproj.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i=new Intent(projectDetails.this,MainActivity.class);
                startActivity(i);
        ...
        viewtask.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(projectDetails.this,TaskList.class);
